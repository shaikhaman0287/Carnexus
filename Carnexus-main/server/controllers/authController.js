...
exports.login = (req, res) => {
    try {
        ...
        // Issue a stateless signed token (JWT-like) to work across Vercel instances
        ...
        const payload = Buffer.from(JSON.stringify({ ...sessionData, iat: Date.now() })).toString('base64url');
